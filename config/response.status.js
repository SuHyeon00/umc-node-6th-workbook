...
export const status = {
    ...
    // member err
    MEMBER_NOT_FOUND: {status: StatusCodes.NOT_FOUND, "isSuccess": false, "code": "MEMBER4001", "message": "사용자가 없습니다."},
    ...
    MISSION_ALREADY_EXIST: {status: StatusCodes.BAD_REQUEST, "isSuccess": false, "code": "VALID4001", "message": "이미 도전을 시작한 미션입니다."},
}